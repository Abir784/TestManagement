            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <form action="{{route('course_based.specific.quiz.question.post')}}" method="POST" enctype="multipart/form-data" >
                          @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            <form action="{{route('course_based.quiz.question.post')}}" method="POST" enctype="multipart/form-data" >
                              @csrf
                              <div class="mb-3 form-group">
                                <input type="hidden" name="quiz_id" value="{{$id}}">
                                <label for="" class="form-lable">Select Question Subject </label>
