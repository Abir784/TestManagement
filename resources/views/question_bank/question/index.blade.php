            ...
            <div class="card">
                ...
                <div class="card-body">
                        <form action="{{route('question.post')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="fields">
                                <p class='text-danger'>*If there are more than one answers in the question please separate the answers with comma(,) , if there is partial marking please give the marks for each option in order separated by comma(,).</p>
