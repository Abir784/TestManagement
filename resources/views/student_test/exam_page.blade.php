...
<div class="container-fluid page__container">
    ...
    <form action="{{route('student.exam.post')}}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card-body">
                ...
                <div id="answerWrapper_1" class="mb-4">
                    ...
                    @elseif ($question->rel_to_question->type =="DESC")
                      <textarea type="text" class="form-control" name="answer_.{{$question->question_id}}[]"></textarea>
