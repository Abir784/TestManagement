...
<!-- Mirrored from lema.frontted.com/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Oct 2022 18:40:46 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="layout-login-centered-boxed__form">
        ...
        <div class="card card-body">
            ...
            <div class="alert alert-soft-success d-flex" role="alert">
                ...
                <div class="text-body">An email with password reset link has been sent to your email address</div>
            </div>
           @endif
            ...
            <form action="{{route('password.update')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input id="email" type="email" class="form-control form-control-prepended @error('email') is-invalid @enderror" name="email" readonly value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input id="password" type="password" reque class="form-control form-control-prepended @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        {{-- <input id="password_2" type="password" required="" class="form-control form-control-prepended" placeholder="Enter your password"> --}}
                        <input id="password-confirm" type="password" reque class="form-control form-control-prepended @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">
