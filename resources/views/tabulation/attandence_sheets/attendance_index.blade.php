...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Course wise Quiz Attendance</h5>
                    <p class="card-text">

                        <form action="{{url('admin/course_wise_exam_attendace_sheet/post')}}" method="POST" enctype="multipart/form-data" >
                          @csrf
                        ...
                        <div class="mb-3 form-group">
                            <label for="" class="form-lable">Select Quiz </label>
                            <select name="quiz_id" class="form-control form-control-rounded" id="quiz_id">
