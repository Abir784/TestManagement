...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Course Wise Attendance Sheet [All Exams]</h5>
                    <p class="card-text">

                        <form action="{{url('admin/course_wise_attendance_sheet/post')}}" method="POST" enctype="multipart/form-data" >
                          @csrf
