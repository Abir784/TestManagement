...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Course Based Tabulation Sheet[Grades]</h5>
                    <p class="card-text">

                        <form action="{{url('admin/course_wise_tabulation_grades/post')}}" method="POST" enctype="multipart/form-data" >
                          @csrf
