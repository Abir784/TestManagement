...
<html lang="en">
	...
	<body>
		<div class="invoice-box">
            <h2 align="center"><u>Course Evaluation</u></h2>
			<table>
				<tr class="top">
					<td colspan="2">
						<table>
...
Batch Number:      {{$student->batch_name->batch_name}}
        ...
        <pre>
            <table class="table table-light" border="2">
                ...
                <tbody>
                    ...
                    @endphp
                        <tr>
                            <td align="center">{{$result['name']}}</td>
                            <td align="center">{{$result['full_marks']}}</td>
                            <td align="center">{{$result['marks_obtained']}}</td>
                            <td align="center">{{number_format($result['gpa'],2)}}</td>
                            <td align="center">{{$result['grade']}}</td>
                        </tr>
                    @endforeach
                ...
                <thead class="thead-dark">
                <tbody>
                    <th colspan="5" align="center">CGPA(Out of 4)</th>
                </thead>
                <tbody>
                    <tr>
                        <td colspan="5"  align="center">{{number_format($cgpa/$i,2)}}</td>
                    </tr>
                </tbody>
                <thead class="thead-dark">
                    <th colspan="5" align="center" >Letter Grade</th>
                </thead>
                <tbody>
                    @if (($cgpa/$i) == 0)
                        <tr>
